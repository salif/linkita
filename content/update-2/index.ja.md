+++
title = "Zola 0.23.3 への移行"
description = "Linkita サイトを Zola v0.23.3 に移行する方法"
date = 2026-08-16
updated = 2026-08-16
[taxonomies]
authors = ["salif"]
...
と表現しており、Linkita のテンプレートもそれに合わせて全面的に書き直す必要がありました。このページでは、Linkita サイトを Zola v0.22.1 から Zola v0.23.3 に移行する手順を説明します。
...
## ステップ 1: Zola を v0.23.3 にアップグレード

Zola v0.23.3 以降をインストールします。インストールされているバージョンを確認してください。
...
Linkita の `main` ブランチは現在、Zola v0.23.3+ を対象としています。`tera1` ブランチは、Zola v0.22.1 以前向けの旧テンプレートエンジン用として維持されます。
