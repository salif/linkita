...
и шаблоните на Линкита трябваше да бъдат пренаписани, за да го следват. Тази страница ви превежда през преместването на сайт с Линкита от Зола 0.22.1 към Зола 0.23.4.
...
## Стъпка 1: Надграждане на Зола до 0.23.4

Инсталирайте Зола 0.23.4 или по-нова. Проверете инсталираната си версия с:
...
Клонът `main` на Линкита вече е насочен към Зола 0.23.0+. Клонът `tera1` остава на стария шаблонен механизъм за Зола 0.22.1 и по-стари версии.
