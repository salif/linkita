+++
title = "الترقية إلى Zola 0.23.3"
description = "كيفية ترحيل موقع Linkita إلى Zola v0.23.3"
date = 2026-08-16
updated = 2026-08-16
[taxonomies]
authors = ["salif"]
...
وكان لا بد من إعادة كتابة قوالب Linkita للتوافق معه. يرشدك هذا الدليل خلال عملية نقل موقع Linkita من Zola v0.22.1 إلى Zola v0.23.3.
...
## الخطوة 1: ترقية Zola إلى v0.23.3

قم بتثبيت Zola v0.23.3 أو إصدار أحدث. تحقق من الإصدار المثبت لديك عبر:
...
يستهدف فرع `main` في Linkita الآن Zola v0.23.3+. يظل فرع `tera1` مخصصاً لمحرك القوالب القديم لـ Zola v0.22.1 والإصدارات الأقدم.
